...
public class FlickrRadonDriver {
	...
	private String datafile = "/media/datasets/flickr/CNN_features/YFCC100M_hybridCNN_gmean_fc6_0.txt"; //"/media/datasets/flickr/alexnet_features/features_extended_vgg19_1.txt"; //"//CNN_features/YFCC100M_hybridCNN_gmean_fc6_10.txt"; //"/media/datasets/flickr/alexnet_features/features.txt"; // //scikit/1M_scikit_30dimData.in";//8dimData_reg_scikit, "10M_19dimData_bshouty.in";//10M_5dimData_bshouty.in"//19dimData_bshouty;
	...
	private double stdDeviation = 100;
	
	public static int totalNumSamples = 0;
	public static int trainingsize = 400000;
	public static void main(String[] args) {
	
		FlickrRadonDriver example = new FlickrRadonDriver();
		example.learn();
				
	}

	public FlickrRadonDriver() {
	}
	
	private void learn() {
	
		FlickrReaderSingleLabel dataStream = null;
		dataStream = new FlickrReaderSingleLabel(datafile, 100);
